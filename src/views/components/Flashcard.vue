<!-- Taken from https://github.com/cuduy197/vue-flashcard -->
<template>
  <div>
    <div
    ...
    >
      ...
      <div class="card-content center">
        <p v-bind:style="{ fontSize: textSizeFront, fontWeight: 'bold' }">
          {{ front }}
        </p>
        <img v-if="imgFront != ''" :src="imgFront" :width="imgFrontWidth" />
      </div>
    ...
    >
      ...
      <div class="card-content center">
        ...
        <img v-if="imgBack != ''" :src="imgBack" :width="imgBackWidth" />
      </div>
